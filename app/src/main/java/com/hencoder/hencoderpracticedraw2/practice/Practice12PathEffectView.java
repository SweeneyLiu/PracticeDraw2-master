...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        dashPath.close();
        PathEffect pathEffect4 = new PathDashPathEffect(dashPath, 40, 0, PathDashPathEffect.Style.MORPH);
        ...
        PathEffect pathEffect5 = new SumPathEffect(dashEffect5, discreteEffect5);
        ...
        PathEffect dashEffect6 = new DashPathEffect(new float[]{20, 10}, 0);
        PathEffect discreteEffect6 = new DiscretePathEffect(20, 5);
        PathEffect pathEffect6 = new ComposePathEffect(dashEffect6, discreteEffect6);
